...
const AccountProvider = (props) => {
    ...
    return (
        <AccountContext.Provider value={
            {me, username, usernameMessage, password, passwordMessage, email, emailMessage,
            incomeData, expenseData, 
            setMe, checkUsername, checkPassword, checkEmail, resetSignInData,
            setIncomeData, setExpenseData}
        } {...props} />
    );
}
